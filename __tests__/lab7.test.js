describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
     ...
     */
    let something = await page.$('product-item');
    let shadowRoot = await something.getProperty('shadowRoot');
    let buttonClick = await shadowRoot.$('button');
    await buttonClick.click();
    let innerTextHandle = await buttonClick.getProperty('innerText');
  ...
  it('Checking number of items in cart on screen', async () => {
     ...
     * Remember to remove the .skip from this it once you are finished writing this test.
     */
       let something1 = await page.$('product-item');
       let shadowRoot1 = await something1.getProperty('shadowRoot');
       let buttonClick = await shadowRoot1.$('button');
       await buttonClick.click();
       let innerTextHandle = await buttonClick.getProperty('innerText');
       let buttonText = await innerTextHandle.jsonValue();
      ...
      let countText = await (await cartCount.getProperty('innerText')).jsonValue();
